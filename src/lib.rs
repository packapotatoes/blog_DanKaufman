    ...
    pub fn search_by_author(&mut self, author: String) -> (Vec<usize>, Vec<(usize, usize)>) {
        ...
        for count in 0 .. self.posts.len() {
            ...
            for com_count in 0 .. self.posts[count].comments.len() {
                if self.posts[count].comments[count].author == author {
...
mod tests {
    ...
    fn search_by_author_test() {
        ...
        blog1.create_post(String::from("Post Title3"), String::from("John Doe"), String::from("Post body3"), None);
        
        let (post_results, commment_results) = blog1.search_by_author(String::from("John Doe"));
    ...
    fn search_by_label_test() {
        ...
        blog1.create_post(String::from("Post Title"), String::from("John Doe"), String::from("Post body"), Some(vec![String::from("label1"), 
                                                                                                                     String::from("label2"), 
                                                                                                                     String::from("label3")]));
        
        blog1.create_post(String::from("Post Title2"), String::from("Jane Doe"), String::from("Post body2"), Some(vec![String::from("label4"), 
                                                                                                                     String::from("label2"), 
                                                                                                                     String::from("label3")]));
        
        blog1.create_post(String::from("Post Title"), String::from("John Doe"), String::from("Post body3"), Some(vec![String::from("label1"), 
                                                                                                                     String::from("label4"), 
                                                                                                                     String::from("label3")]));
        
        let post_results = blog1.search_by_label(String::from("label2"));
        
        let expected_results = vec![0, 1];
